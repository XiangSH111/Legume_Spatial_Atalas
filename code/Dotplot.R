...
my_gene_list <- read.table('../data/plot_gene.txt',header = T,sep = '\t')
gene_ID <- my_gene_list[,4]
gene_name <- my_gene_list[,2]
...
pdf("../output/MX_dotplot_ID_SCT.pdf",width=15,height=6)
...
pdf("../output/MX_dotplot_name_SCT.pdf",width=15,height=6)
